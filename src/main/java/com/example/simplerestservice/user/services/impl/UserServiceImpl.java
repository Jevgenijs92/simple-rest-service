package com.example.simplerestservice.user.services.impl;
...
import com.example.simplerestservice.user.repository.RoleRepository;
import com.example.simplerestservice.user.repository.UserRepository;
...
public class UserServiceImpl implements UserService, UserDetailsService {
    ...
    @Override
    public User saveUser(CreateNewUserForm userForm) {
        if (Objects.nonNull(userRepository.findByUsername(userForm.getUsername()))) {
    ...
    public Role saveRole(Role role) {
        if (Objects.nonNull(roleRepository.findByName(role.getName()))) {
            log.warn("Role already exists in database.");
            return null;
        }
    ...
    public void addRoleToUser(String username, String roleName) {
        ...
        if(user.getRoles().contains(role)) {
            log.info("Username and role combination already exists");
        } else {
